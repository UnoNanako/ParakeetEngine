...
void ImGuiManager::Initialize(std::shared_ptr<WinApp> winApp, std::shared_ptr<DirectXCommon> dxCommon) {
	//ImGuiのコンテキストを生成
	ImGui::CreateContext();
	//ImGuiのスタイルを設定
...
void ImGuiManager::Draw(std::shared_ptr<DirectXCommon> dxCommon){
