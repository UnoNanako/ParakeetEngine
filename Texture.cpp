...
void Texture::Create(std::shared_ptr<DirectXCommon> dxCommon, const std::string& filePath){
	//Textureを読んで転送する
	DirectX::ScratchImage mipImages = LoadTexture(filePath);
	const DirectX::TexMetadata& metadata = mipImages.GetMetadata();
	mResource = CreateTextureResource(dxCommon->GetDevice().Get(), metadata);
	UploadTextureData(mResource.Get(), mipImages);
	...
	mSrvHandleGPU = dxCommon->GetGPUDescriptorHandle();
	// SRVの生成
